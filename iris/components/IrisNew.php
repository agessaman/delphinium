...
use Delphinium\Iris\Controllers\IrisNew as MyController;
use Delphinium\Iris\Models\IrisNew as MyModel;
use Cms\Classes\ComponentBase;
class IrisNew extends ComponentBase
{
    /**
    ...
    {
        return ['name' => 'Iris-New', 'description' => ''];
    }
    /**
    ...
    {
        return ['instance' => ['title' => '(Optional) IrisNew instance', 'description' => 'Select the iris-new instance to display. If an instance is selected, it will be
    ...
    public function onRun()
    {
        try {
            ...
            //IN Delphinium\Iris\controllers\IrisNew\_instructions.htm
            ...
            if (stristr($roleStr, 'Instructor') || stristr($roleStr, 'TeachingAssistant')) {
                ...
                $this->addJs('/plugins/delphinium/iris/assets/iris-new_instructor.js');
                $formController = new MyController();
                $formController->create('frontend');
                //Append the formController to the page
                $this->page['iris-newform'] = $formController;
                //Append the Instructions to the page
                $instructions = $formController->makePartial('iris-newinstructions');
                $this->page['iris-newinstructions'] = $instructions;
            } else {
