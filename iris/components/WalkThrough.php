...
use Delphinium\Iris\Controllers\WalkThrough as MyController;
use Delphinium\Iris\Models\WalkThrough as MyModel;
use Cms\Classes\ComponentBase;
class WalkThrough extends ComponentBase
{
    /**
    ...
    {
        return ['name' => 'Walk Through', 'description' => ''];
    }
    /**
    ...
    {
        return ['instance' => ['title' => '(Optional) WalkThrough instance', 'description' => 'Select the walk through instance to display. If an instance is selected, it will be
    ...
    public function onRun()
    {
        try {
            ...
            //IN Delphinium\Iris\controllers\WalkThrough\_instructions.htm
            ...
            if (stristr($roleStr, 'Instructor') || stristr($roleStr, 'TeachingAssistant')) {
                ...
                $this->addJs('/plugins/delphinium/iris/assets/walkthrough_instructor.js');
                $formController = new MyController();
                $formController->create('frontend');
                //Append the formController to the page
                $this->page['walkthroughform'] = $formController;
                //Append the Instructions to the page
                $instructions = $formController->makePartial('walkthroughinstructions');
                $this->page['walkthroughinstructions'] = $instructions;
            } else {
    ...
    {
        $data = post('WalkThrough');
        //model name
        $id = $this->page['walkthroughrecordId'];
