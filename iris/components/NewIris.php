...
class NewIris extends ComponentBase
{
	
	public function componentDetails()
    {
        return [
            'name'        => 'New Iris Sunburst Chart',
            'description' => 'New Sunburst chart representing the modules of a course and the student\'s progress in it'
        ];
    }
