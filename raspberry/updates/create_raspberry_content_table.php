...
class CreateRaspberryContentTable extends Migration
{

    public function up()
    {
     	if ( !Schema::hasTable('delphinium_raspberry_content') )
    	{
        	Schema::create('delphinium_raspberry_content', function($table)
        	{
            	$table->engine = 'InnoDB';
    ...
    public function down()
    {
	    if ( Schema::hasTable('delphinium_raspberry_content') )
    	{
        	Schema::drop('delphinium_raspberry_content');
    	}
    }
