...
class CreateCoreContentTable extends Migration
{

    public function up()
    {
     	if ( !Schema::hasTable('delphinium_core_content') )
    	{
        	Schema::create('delphinium_core_content', function($table)
        	{
            	$table->engine = 'InnoDB';
    ...
    public function down()
    {
	    if ( Schema::hasTable('delphinium_core_content') )
    	{
        	Schema::drop('delphinium_core_content');
    	}
    }
