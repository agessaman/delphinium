...
class CreateCoreModuleItemsTable extends Migration
{

    public function up()
    {
     	if ( !Schema::hasTable('delphinium_core_module_items') )
    	{
            Schema::create('delphinium_core_module_items', function($table)
            {
            $table->engine = 'InnoDB';
    ...
    public function down()
    {
	    if ( Schema::hasTable('delphinium_core_module_items') )
    	{
        	Schema::drop('delphinium_core_module_items');
    	}
    }
