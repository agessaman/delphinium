...
return [
    'plugin' => [
        ...
        'field_author_namespace_description' => 'You cannot change the namespaces with Editor after you create the plugin. Example author namespace: JohnSmith',
        ...
        'error_settings_not_editable' => 'Settings of this plugin cannot be edited with Editor.',
    ...
    'database' => [
        ...
        'error_enum_not_supported' => 'The table contains column(s) with type "enum" which is not currently supported by the Editor.',
    ...
    'controller' => [
        ...
        'controller_behaviors_description' => 'Select behaviors the controller should implement. Editor will create view files required for the behaviors automatically.',
        'controller_permissions' => 'Permissions',
        'controller_permissions_description' => 'Select user permissions that can access the controller views. Permissions can be defined on the Permissions tab of the Editor. You can change this option in the controller PHP script later.',
    ...
    'version' => [
        ...
        'hint_save_unapplied' => 'You saved an unapplied version. Unapplied versions could be automatically applied when you or another user logs into the back-end or when a database table is saved in the Database section of the Editor.',
        'hint_rollback' => 'Rolling back a version will also roll back all versions newer than this version. Please note that unapplied versions could be automatically applied by the system when you or another user logs into the back-end or when a database table is saved in the Database section of the Editor.',
    ...
    'migration' => [
        ...
        'field_description' => 'Description',
        'field_code' => 'Code',
        'field_code_comment' => 'The migration code is read-only and for the preview purpose only. You can create custom migrations manually in the Versions section of the Editor.',
