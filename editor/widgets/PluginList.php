<?php namespace Delphinium\Editor\Widgets;
...
class PluginList extends WidgetBase
{
    ...
    public $noRecordsMessage = 'delphinium.editor::lang.plugin.no_records';
    ...
    protected function getPluginList()
    {
        ...
        foreach ($plugins as $code=>$plugin) {
            ...
            $itemInfo = [
                'name' => isset($pluginInfo['name']) ? $pluginInfo['name'] : 'delphinium.editor::lang.plugin.no_name',
                'description' => isset($pluginInfo['description']) ? $pluginInfo['description'] : 'delphinium.editor::lang.plugin.no_description',
