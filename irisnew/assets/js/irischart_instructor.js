...
function showIrisChartModal()
{
    $("#irischart-content-configuration").on("shown.bs.modal", function () {
        //you may disable fields that should not be edited by professors
        //document.getElementById('yourid').style.display='none';
    }).modal('show');
}

function hideIrisChartModal()
{
    $('#irischart-content-configuration').modal('hide');
}