...
use Delphinium\Irisnew\Controllers\WalkThrough as MyController;
use Delphinium\Irisnew\Models\WalkThrough as MyModel;
use Cms\Classes\ComponentBase;
class IrisWalkThrough extends ComponentBase
{
    /**
    ...
    {
        return ['name' => 'IrisWalkThrough Component', 'description' => ''];
    }
    /**
    ...
    {
        return ['instance' => ['title' => '(Optional) IrisWalkThrough instance', 'description' => 'Select the iriswalkthrough instance to display. If an instance is selected, it will be
    ...
    public function onRun()
    {
        try {
            ...
            //IN Delphinium\Irisnew\controllers\IrisWalkThrough\_instructions.htm
            ...
            if (stristr($roleStr, 'Instructor') || stristr($roleStr, 'TeachingAssistant')) {
                ...
                $this->addJs('/plugins/delphinium/irisnew/assets/walkthrough_instructor.js');
