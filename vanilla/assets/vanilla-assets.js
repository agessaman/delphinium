...
+function ($) { "use strict";
    ...
    AssetsPage.prototype = Object.create(BaseProto)
    AssetsPage.prototype.constructor = AssetsPage
    ...
    AssetsPage.prototype.registerHandlers = function() {
     ...
     */
    AssetsPage.prototype.handleMtimeMismatch = function (form) {
        var $form = $(form)
     ...
     */
    AssetsPage.prototype.reloadForm = function($form) {
        var data = {
     ...
     */
    AssetsPage.prototype.updateModifiedCounter = function() {
        var counters = {
     ...
     */
    AssetsPage.prototype.onTabShown = function(e) {
     ...
     */
    AssetsPage.prototype.onAllTabsClosed = function() {
     ...
     */
    AssetsPage.prototype.onTabClosed = function() {
     ...
     */
    AssetsPage.prototype.onAjaxError = function(event, context, data, jqXHR) {
     ...
     */
    AssetsPage.prototype.onAjaxSuccess = function(event, context, data) {
    ...
    AssetsPage.prototype.onBeforeSaveContent = function(e, data) {
     ...
     */
    AssetsPage.prototype.setPageTitle = function(title) {
     ...
     */
    AssetsPage.prototype.updateObjectList = function(objectType) {
     ...
     */
    AssetsPage.prototype.closeTabs = function(data, type) {
        var self = this
     ...
     */
    AssetsPage.prototype.onSidebarItemClick = function(e) {
        var self = this,
     ...
     */
    AssetsPage.prototype.onCreateObject = function(e) {
        var self = this,
            $button = $(e.target),
     ...
     */
    AssetsPage.prototype.onSidebarSubmenuItemClick = function(e) {
     ...
     */
    AssetsPage.prototype.onDeleteObject = function(e) {
        var $el = $(e.target),
     ...
     */
    AssetsPage.prototype.onLayoutChanged = function(e) {
        var
            self = this,
            $el = $(e.target),
            $form = $el.closest('form'),
     ...
     */
    AssetsPage.prototype.onInitTab = function(e, data) {
     ...
     */
    AssetsPage.prototype.onSaveMenu = function(e, data) {
        var form = e.currentTarget,
            items = [],
     ...
     */
    AssetsPage.prototype.updateContentEditorMode = function(pane, initialization) {
     ...
     */
    AssetsPage.prototype.getContentExtension = function(form) {
