...
* Your server root will be `www` under WAMP or `htdocs` under MAMP/XAMPP
  ...
  7. Now go to [this Url](https://www.youtube.com/watch?v=V0c8cKe-heI) and follow the instructions on how to create a fork.  You'll want to create the following directory `/delphinium` and create your fork here.
