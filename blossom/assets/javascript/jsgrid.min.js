...
! function(a, b, c) {
    ...
    d.prototype = {
        ...
        _init: function(a) {
            b.extend(this, a), this._initLoadStrategy(), this._initController(), this._initFields(), this._attachWindowLoadResize(), this._attachWindowResizeCallback()
        },
        ...
        _initController: function() {
            this._controller = b.extend({}, u, t(this.controller, this))
        },
        ...
        _createHeaderRow: function() {
            ...
            return this._eachField(function(c, d) {
                var e = this._prepareCell("<th>", c, "headercss").append(c.headerTemplate ? c.headerTemplate() : "").appendTo(a);
        ...
        _prepareCell: function(a, c, d) {
            return b(a).css("width", c.width).addClass(d && c[d] || c.css).addClass(c.align ? "jsgrid-align-" + c.align : "")
        },
        _createFilterRow: function() {
            ...
            return this._eachField(function(b) {
                this._prepareCell("<td>", b, "filtercss").append(b.filterTemplate ? b.filterTemplate() : "").appendTo(a)
            }), a
        },
        _createInsertRow: function() {
            ...
            return this._eachField(function(b) {
                this._prepareCell("<td>", b, "insertcss").append(b.insertTemplate ? b.insertTemplate() : "").appendTo(a)
            }), a
        },
        ...
        _createNoDataRow: function() {
            ...
            return this._eachField(function() {
                c++
            }), b("<tr>").addClass(this.noDataRowClass).append(b("<td>").attr("colspan", c).append(a))
        },
        ...
        _createRow: function(a, c) {
            var d;
            return b.isFunction(this.rowRenderer) ? d = b(this.rowRenderer(a, c)) : (d = b("<tr>"), this._renderCells(d, a)), d.addClass(this._getRowClasses(a, c)).data(g, a).on("click", b.proxy(function(b) {
                this.rowClick({
                    item: a,
                    itemIndex: c,
                    event: b
        ...
        _createCell: function(a, c) {
            ...
            return d = b.isFunction(c.cellRenderer) ? b(c.cellRenderer(e, a)) : b("<td>").append(c.itemTemplate ? c.itemTemplate(e, a) : e), this._prepareCell(d, c)
        },
        ...
        _setSortingParams: function(a, b) {
            if(sortType[2]) {
                a = this._normalizeField(a), b = b || (this._sortField === a ? this._reversedSortOrder(this._sortOrder) : i), this._sortField = a, this._sortOrder = sortType[1]
            } else {
        ...
        _setSortingCss: function() {
            var a = b.inArray(this._sortField, b.grep(this.fields, function(a) {
                return a.visible
            }));
        ...
        _refreshWidth: function() {
            var a = this._headerGrid,
                b = this._bodyGrid,
                c = this.width;
            "auto" === c && (a.width("auto"), c = a.outerWidth()), a.width(""), b.width(""), this._container.width(c), c = a.outerWidth(), b.width(c)
        },
        ...
        _setPage: function(a) {
            ...
            this.pageIndex = a, b > a && (this._firstDisplayingPage = a), a > b + c - 1 && (this._firstDisplayingPage = a - c + 1)
        },
        ...
        mSort: function(a,c) {
            sortType[2] = true;
            if ($('.jsgrid-header-row th').hasClass('jsgrid-header-sort-asc')) {
                sortType[1] = 'asc';
            } else if ($('.jsgrid-header-row th').hasClass('jsgrid-header-sort-desc')) {
                sortType[1] = 'desc';
            }
            console.log(sortType[1]);
            console.log('order');
            console.log(this._sortOrder);
            console.log(sortType[2]);
            return b.isPlainObject(a) && (c = a.order, a = a.field), this._clearSortingCss(), this._setSortingParams(a, c), this._setSortingCss(), this._loadStrategy.sort()
        },
        mySort: function () {
            return this.mSort(sortType[0]);
        },
        ...
        _validateItem: function(a, c) {
            ...
            if (this._eachField(function(f, g) {
                    if (f.validate) {
                        var h = this._validation.validate(b.extend({
                            value: this._getItemFieldValue(a, f),
                            rules: f.validate
                        }, e));
                        this._setCellValidity(c.children().eq(g), h), h.length && d.push.apply(d, b.map(h, function(a) {
                            return {
                                field: f,
                                message: a
                            }
        ...
        _createEditRow: function(a) {
            ...
            return this._eachField(function(b) {
                ...
                this._prepareCell("<td>", b, "editcss").append(b.editTemplate ? b.editTemplate(d, a) : "").appendTo(c)
            }), c
        },
        ...
        _updateRow: function(a, c) {
            ...
            return this._controllerCall("updateItem", d, h.cancel, function(b) {
                b = b || d;
        ...
        _getEditRow: function() {
            return this._editingRow.data(h)
        },
    ...
    var v = {},
        w = function(a) {
            var c;
            b.isPlainObject(a) ? c = d.prototype : (c = v[a].prototype, a = arguments[1] || {}), b.extend(c, a)
        },
        x = {},
        y = function(a) {
            var c = b.isPlainObject(a) ? a : x[a];
            if (!c) throw Error("unknown locale " + a);
            z(jsGrid, c)
        },
        z = function(a, c) {
            b.each(c, function(c, d) {
                return b.isPlainObject(d) ? void z(a[c] || a[c[0].toUpperCase() + c.slice(1)], d) : void(a.hasOwnProperty(c) ? a[c] = d : a.prototype[c] = d)
            })
        };
    a.jsGrid = {
        Grid: d,
...
function(a, b, c) {
    function d(a) {
        this.items = [], this.selectedIndex = -1, this.valueField = "", this.textField = "", a.valueField && a.items.length && (this.valueType = typeof a.items[0][a.valueField]), this.sorter = this.valueType, e.call(this, a)
    }
    var e = a.NumberField;
    d.prototype = new e({
        align: "center",
