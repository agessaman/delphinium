...
class Iris extends ComponentBase
{
    ...
    public function defineProperties()
    {
        return [
            'instance'	=> [
                'title'             => '(Optional) Iris instance',
                'description'       => 'Select the iris instance to display. If an instance is selected, it will be
    ...
    public function onRun()
    {
        ...
        try
        {
            ...
            //IN Delphinium\Blossom\controllers\Iris\_instructions.htm
            ...
            if(stristr($roleStr, 'Instructor')||stristr($roleStr, 'TeachingAssistant'))
             ...
             //if you desire to use OctoberCMS' ui library (See https://octobercms.com/docs/ui/form) uncomment the following three lines
                ...
                $this->addJs('/plugins/delphinium/blossom/assets/iris_instructor.js');
                $formController = new MyController();
                $formController->create('frontend');

                //Append the formController to the page
                $this->page['irisform'] = $formController;

                //Append the Instructions to the page
                $instructions = $formController->makePartial('irisinstructions');
                $this->page['irisinstructions'] = $instructions;
            }
    ...
    public function onUpdate()
    {
        ...
        $data = post('Iris');//model name
        $id = $this->page['irisrecordId'];// convert string to integer
