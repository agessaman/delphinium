...
namespace Delphinium\Blade\Classes\Rules\RuleBuilder;

use Delphinium\Blade\Classes\Rules\Operator;
use Delphinium\Blade\Classes\Rules\Operator\VariableOperator;
use Delphinium\Blade\Classes\Rules\RuleBuilder;
use Delphinium\Blade\Classes\Rules\Variable as BaseVariable;
...
class Variable extends BaseVariable implements \ArrayAccess
{
    ...
    {
        $reflection = new \ReflectionClass('\\Delphinium\\Blade\\Classes\\Rules\\Operator\\' . $name);
